...
class main extends Layout{
    ...
    public function drawRightOfMain(){
        ...
        echo '       
                <h3 style="font-size: 32px;margin-top: 130px; ">상품 등록</h3>
                <form action="../dataProcessing/addClothesDataProcessing.php" method="post" enctype="multipart/form-data">
                    <div class="addClothesBigContainer">
                        ...
                        <div class="addClothesContainerRight">
                            <div class="addClothesRightBody" style="vertical-align: center">
                                <input type="text" name="addClothesClothesName"></input>
                            ...
                            <div class="addClothesRightBody" id="addClothesRightMainImage">
                                ...
                                <input type="file" name="addClothesImage" id="image" accept="image/*" onclick="deleteThumbnail()" onchange="setThumbnail(event);" style="margin-left: 10px; margin-top: 100px"/><br>
                            </div>
                            <textarea id="summernote" name="editordata"></textarea>
                        </div>
                    </div>
                    <input type="submit" name="submit" value="상품 등록" style="margin-left:400px;margin-top: 10px;cursor: pointer"/>
                </form>
            ';
        echo '<script>
