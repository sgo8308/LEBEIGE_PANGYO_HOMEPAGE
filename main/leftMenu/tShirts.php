...
class tShirtsLayOut extends ListLayout{
    public $dataNum ;
    ...
    public function accessClothesTable()
    {
        global $clothesDbConnection;
        $conn= $clothesDbConnection;
        $query = "SELECT * FROM Clothes WHERE (category1 = '티셔츠') ORDER BY id DESC LIMIT $this->startPoint,$this->dataNumForPage";
        $result = mysqli_query($conn, $query);
        return $result;
    }
...
?>
<script>
    document.getElementById("navTitle").textContent = "티셔츠";
</script>
</body>
</html>
