...
<body>
<h1 style="font-size: 20px">이용약관</h1>
<div class="section">

    <h3 class="first">
        <a name="a1">제 1 조 (목적)</a>
    </h3>
    <p>이 약관은 르베이지 판교점 ("회사" 또는 "르베이지 판교점")이 제공하는 르베이제 판교점 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
    <h3>
    ...
    <ol>
        <li><span class="first_letter">①</span>"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 르베이지 판교점 관련 제반 서비스를 의미합니다.</li>
    ...
    <h3>
        <a name="a6">제 5 조 (회원정보의 변경)</a>

    </h3>
    <ol>
        <li><span class="first_letter">①</span>"회원"은 개인정보관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 아이디는 수정이 불가능합니다. </li>
    ...
    <h3>
        <a name="a8">제 7 조 ("회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무)</a>
    </h3>
    <ol>
    ...
    <h3>
        <a name="a12">제 11 조 ("서비스"의 제공 등)</a>
    </h3>
    <ol>
        <li><span class="first_letter">①</span>회사는 회원에게 아래와 같은 서비스를 제공합니다.
            <ol>

                <li><span class="first_letter">1.</span>의류 열람 서비스 </li>
                <li><span class="first_letter">2.</span>게시판형 서비스(매장후기, Q&A 등) </li>

                <li><span class="first_letter">3.</span>기타 "회사"가 추가 개발하거나 다른 회사와의 제휴계약 등을 통해 "회원"에게 제공하는 일체의 서비스 </li>
            </ol>
        </li>
    ...
    <h3>
        <a name="a14">제 13 조 (정보의 제공 및 광고의 게재)</a>
    </h3>
    <ol>
    ...
    <h3>
        <a name="a17">제 16 조 (권리의 귀속)</a>
    </h3>
    <ol>

        <li><span class="first_letter">①</span>"서비스"에 대한 저작권 및 지적재산권은 "회사"에 귀속됩니다. 단, "회원"의 "게시물" 및 제휴계약에 따라 제공된 저작물 등은 제외합니다. </li>
        <li><span class="first_letter">②</span>"회사"는 서비스와 관련하여 "회원"에게 "회사"가 정한 이용조건에 따라 계정, "아이디", 콘텐츠 등을 이용할 수 있는 이용권만을 부여하며, "회원"은 이를 양도, 판매, 담보제공 등의 처분행위를 할 수 없습니다. </li>
...
<!--        "회사"는 서비스의 효율적 이용 및 운영을 위해 사전 공지 후 "포인트"의 일부 또는 전부를 조정할 수 있으며, "포인트"는 회사가 정한 기간에 따라 주기적으로 소멸할 수 있습니다. </p>-->
    ...
    <h3>
        <a name="a19">제 17 조 (계약해제, 해지 등)</a>
    </h3>
    <ol>
        <li><span class="first_letter">①</span>"회원"은 언제든지 서비스초기화면의 내 정보 관리 메뉴 등을 통하여 이용계약 해지 신청을 할 수 있으며, "회사"는 관련법 등이 정하는 바에 따라 이를 즉시 처리하여야 합니다. </li>
        <li><span class="first_letter">②</span>"회원"이 계약을 해지할 경우, 관련법 및 개인정보처리방침에 따라 "회사"가 회원정보를 보유하는 경우를 제외하고는 해지 즉시 "회원"의 모든 데이터는 소멸됩니다. </li>

        <li><span class="first_letter">③</span>"회원"이 계약을 해지하는 경우, "회원"이 작성한 "게시물"은 삭제되지 않으니 사전에 삭제 후 탈퇴하시기 바랍니다. </li>
    </ol>
    <h3>

        <a name="a20">제 18 조 (이용제한 등)</a>
    </h3>
    <ol>
        ...
        <li><span class="first_letter">②</span>"회사"는 전항에도 불구하고, "주민등록법"을 위반한 명의도용 및 결제도용, "저작권법" 및 "컴퓨터프로그램보호법"을 위반한 불법프로그램의 제공 및 운영방해, "정보통신망법"을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련법을 위반한 경우에는 즉시 영구이용정지를 할 수 있습니다. 본 항에 따른 영구이용정지 시 "회사"는 이에 대해 별도로 보상하지 않습니다. </li>
    ...
    <h3>
        <a name="a22">제 20 조 (준거법 및 재판관할)</a>
    </h3>
    <ol>
    ...
    <ol>
        ...
        <li><span class="first_letter">①</span>이 약관은 2020년 12월 25일부터 적용됩니다. </li>
    </ol>
