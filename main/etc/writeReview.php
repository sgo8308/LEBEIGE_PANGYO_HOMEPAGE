...
class main extends Layout{
    ...
    public function drawRightOfMain(){
        echo '       
                <h3 style="font-size: 32px;margin-top: 130px; ">리뷰 작성</h3>
                    ...
                    <div class="writeReviewBigContainer">
                        ...
                        <div class="writeReviewContainerRight">
                            <div class="writeReviewRightBody" style="vertical-align: center">
                                <input type="text" name="writeReviewTitle" placeholder="제목은 100글자까지 작성 가능합니다."></input>                               
                            </div>                           
                            <textarea id="summernote" name="editordata"></textarea>
                        </div>
                    </div>
                    <input type="submit" name="submit" value="작성 완료" style="margin-left:400px;margin-top: 10px;cursor: pointer"/>
                </form>
            ';
        echo '<script>
